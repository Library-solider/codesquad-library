...
class BookAdminRepositoryTest {
    ...
    public void 모든_도서정보를_카테고리와_함께_조회한다(int page, int pageSize, int index,
        ...
        //when
        Page<Book> books = bookAdminRepository.findAllFetch(PageRequest.of(page - 1, pageSize));
        ...
        assertAll(
                ...
                () -> Assertions.assertThat(selectedBook.getCategory().getTitle()).isEqualTo(categoryTitle),
